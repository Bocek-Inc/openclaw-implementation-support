...
- `streaming: "partial"` + `nativeStreaming: true` の組み合わせで、初回スレッド返信がチャンネルにも投稿される二重投稿バグが発生（2026-03-23時点）
- 対策: `streaming: "off"`, `nativeStreaming: false` に変更
- 本体Issue: openclaw/openclaw#52536
- 修正されたら `streaming: "partial"` に戻してOK
